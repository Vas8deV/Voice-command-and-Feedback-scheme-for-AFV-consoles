...
class System:
    def __init__(self):
        ...
        loadmodel_start = sec.time()
        self.model = WhisperModel(Model, device="cpu", compute_type="int8")
        print("\nModel Loading time :",sec.time()-loadmodel_start," seconds")
        ...
        if len(txt_analyze.split()) in range(2,6):
            ...
            # BEEPER (HORN) CONTROL
                ...
                if "on" in txt_analyze:
                    ...
                    self.speak("Command 003 activated")

                elif "of" in txt_analyze:
                    print("\033[96m command 004 (HORN-OFF) activated.\033[0m")
                    self.speak("Command 004 activated")
    ...
    def decision_tree(self,txt):
        ...
        # if not inside voice mode
	        ...
	        if voice_mode_checkin:
	            self.speak("Voice mode is activated.") 
    ...
    def transcribe(self):
        ...
        transcribe_start = sec.time()
        texts = [segment.text for segment in segments]
        if texts: 
            trb_txt = texts[0] # to handle errors for list out of range. 
            print("Transcription Time: ",sec.time()-transcribe_start, " seconds")
            print("Transcribed text: ", trb_txt)
...
# can skip transcription if transcribe time is greater than 2 seconds on base model or tiny model